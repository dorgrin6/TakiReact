const gameController = (function (logic, view) {
    ...
    function cardSelected(cardId) {
        const player = logic.getActivePlayer();
    ...
    return {
        runGame: function () {
            ...
            view.onCardClick.attach(function (args) {
                const cardId = parseInt(args.cardDOM.getAttribute("data-cardId"));
                cardSelected(cardId);
            });
            ...
            for (let i = 0; i < logic.players.length; i++) {
